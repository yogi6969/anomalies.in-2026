        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="mb-8 flex justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-slate-600 ring-1 ring-slate-900/10 hover:ring-slate-900/20 bg-white/50 backdrop-blur">
              Built for Indian Businesses <span className="font-semibold text-primary-600 ml-1">AI-Powered</span>
            </div>
          </div>

          <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-6xl lg:text-7xl leading-tight">
            Your Sales Workflow, <br className="hidden sm:block" />
          ...
          <p className="mt-6 text-lg leading-8 text-slate-600 max-w-2xl mx-auto">
            We plug into your existing sales tools — email, WhatsApp, CRM — and use AI to find what's not working and suggest what will. Built for Indian SMB founders.
          </p>
